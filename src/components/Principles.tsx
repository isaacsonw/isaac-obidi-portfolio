...
export default function Principles() {
  ...
  return (
    <section
      ...
      className='hscroll-section relative md:h-[200vh]'>
      <div className='hscroll-sticky md:sticky md:top-[12vh] md:flex md:h-[50vh] md:flex-col md:justify-center md:overflow-hidden'>
        <div className='mx-auto w-full max-w-6xl px-6 pt-10 md:pt-0'>
        ...
        <div className='hscroll-viewport no-scrollbar mt-8 snap-x snap-mandatory overflow-x-auto md:mt-10 md:snap-none md:overflow-x-hidden'>
          <div
            ref={trackRef}
            ...
            {principles.map((principle, i) => (
              <article
                key={principle.title}
                className='flex min-h-64 w-[80vw] shrink-0 snap-start flex-col justify-between rounded-2xl border border-border-strong bg-surface p-7 sm:w-[24rem] sm:p-9 md:w-108'>
